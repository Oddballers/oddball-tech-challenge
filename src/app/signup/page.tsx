...
export default function SignupPage() {
    ...
    try {
      ...
      try {
        ...
        toast({
          ...
          title: 'Signup Failed',
          description:
            'Could not save user data. This might be due to security rules. Please contact an admin.',
        })
        setIsLoading(false)
        return
      }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 m-auto w-full">
