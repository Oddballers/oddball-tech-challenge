...
export const GenerateCustomChallengeOutputSchema = z.object({
  ...
  requiredSkills: z
    .string()
    .describe('A comma seperated list of the required skills for the challenge'),
...
export const PromptChallengeCreationOutputSchema = z.object({
  ...
  expectedOutput: z.string().describe('The expected output or solution for the challenge.'),
})
